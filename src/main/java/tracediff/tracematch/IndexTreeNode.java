...
import tracediff.codeanalysis.ast.LoopHeadParser;
...
//		p.setLoopScope(null);
		if(p.getLoopScope()==null){
			CompilationUnit cu = JavaUtil.findCompilationUnitBySourcePath(p.getFullJavaFilePath(), p.getDeclaringCompilationUnitName());
